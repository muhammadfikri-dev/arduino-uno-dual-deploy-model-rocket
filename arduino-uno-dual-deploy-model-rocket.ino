/**
 * =========================================================================================
 * Project     : Arduino Uno High-Power Model Rocket Dual-Deployment Flight Computer
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Rocketry flight computer with BMP280 barometer and ADXL375 high-G accelerometer, detecting apogee for drogue chute and 150m AGL for main parachute ejection charges.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno High-Power Model Rocket Dual-Deployment Flight Computer"));
