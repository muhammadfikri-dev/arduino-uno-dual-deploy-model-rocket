# ⚡ Arduino Uno High-Power Model Rocket Dual-Deployment Flight Computer
...
Rocketry flight computer with BMP280 barometer and ADXL375 high-G accelerometer, detecting apogee for drogue chute and 150m AGL for main parachute ejection charges.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `EEPROM`
4. Buka berkas [`arduino-uno-dual-deploy-model-rocket.ino`](./arduino-uno-dual-deploy-model-rocket.ino).
